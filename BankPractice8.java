	...
	public void load() {
		try {
			...
			while (rs.next()) {
				...
				Member member = new Member(rs.getString(1), rs.getString(2), rs.getString(3), Integer.parseInt(rs.getString(4)), rs.getString(5), rs.getString(6));
				list.add(member);
			}
		} catch (Exception e) {
			e.printStackTrace();
...
//		selectAddress();
	...
	public void selectAddress() {
		...
		try {
			String sql = "SELECT * FROM ZIPCODE WHERE DONG like '%" + scanner.next() + "%'";
...
//				if (i == num) {
//					sb.append(rs.getString("SIDO")).append(" ").append(rs.getString("GUGUN")).append(" ").append(rs.getString("DONG")).append(" ").append(rs.getString("BLDG")).append(" ");
...
//			System.out.println(sb.toString());
	...
	public static void main(String args[]) {
		BankPractice8 bankpractice8 = new BankPractice8();
		bankpractice8.menu();
